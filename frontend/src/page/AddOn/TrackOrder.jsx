            ...
            <div className="container">
                <div className=" padding-bottom-3x mb-1">
                    <div className="card mb-3">
                        <div className="p-4 text-center text-white text-lg bg-dark rounded-top"><span className="text-uppercase">Tracking Order No - </span><span className="text-medium">{
                        }</span></div>
                    ...
                    <div className="d-flex flex-wrap flex-md-nowrap justify-content-center justify-content-sm-between align-items-center">
                        ...
                        <div className="text-left text-sm-right"><button className="btn btn-info ml-1 mr-1" onClick="">View Order Details</button></div>
                    </div>
                </div>
            </div>
        </div>
