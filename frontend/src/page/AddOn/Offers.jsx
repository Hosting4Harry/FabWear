        ...
        <div className='row d-flex bg-light mb-3 shadow ' >
            ...
            <div className='col d-flex border-left my-3'>
                ...
                <div className='pt-3'>
                    ...
                    <span font-size="16px" color="grey.600" class="sc-96a18268-0 gUjlsQ">7 Days Return</span>
                </div>
            </div>
            <div className='col d-flex border-left my-3'>
                ...
                <div className='pt-3'>
                    ...
                    <span font-size="16px" color="grey.600" class="sc-96a18268-0 gUjlsQ">Customer Services</span>
                </div>
            </div>
